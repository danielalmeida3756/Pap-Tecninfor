...
?>
		...
		<div id="fh5co-main">
				...
				<h2 class="fh5co-heading animate-box col-lg-offset-3 col-lg-5 text-center" data-animate-effect="fadeInLeft">Login</span></h2>
				<div class="row animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item  col-lg-12">
					
				
			<form method="post" name="contact-form" class="contact-form" class="text-center" action="inserirlogin.php">
             <div class="col-md-6 col-sm-6 col-xs-12 pad-l-3 col-lg-offset-3 col-lg-5">
                <div class="form-group">
                    <input name="name" type="text" class="form-control" id="utilizador" placeholder="Utilizador" required>
                </div> 
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 pad-l-3 col-lg-offset-3 col-lg-5">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 text-center col-lg-offset-3 col-lg-5">
							<p><input type='submit' name='Entrar' class="btn btn-primary btn-outline" /></p>
							<p><a href="registo.php" class="btn btn-primary btn-outline">Regista-te aqui</a></p>
				</div>
        ...
        <div id="msgSubmit" class="h3 text-center hidden">Login bem sucedido ! </div>
