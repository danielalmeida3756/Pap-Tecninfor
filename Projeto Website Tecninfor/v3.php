				...
				<div class="row">
					...
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<figure class="text-center">
							<img src="images/v3.jpg" alt="Free HTML5 Bootstrap" class="img-responsive">
						</figure>
					</div>
					...
					<div class="col-md-8 col-md-offset-2 animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="col-md-9 col-md-push-3">
							<h1>Computador Basic v3</h1>
							<p>Equipado com processador intel core i5-2410M, motherboard HM65MAL, 8Gb de ram, SSD de 120 Gb e Windows 10 Pro. Este computador é bom para quem procura um computador para entrar no mundo dos jogos.</p>
				...
				<div class="row work-pagination animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="v2.php"><i class="icon-long-arrow-left"></i> <span> Artigo anterior</span></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="artigos.php"><i class="icon-th-large"></i></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="advanced.php"><span>Artigo seguinte </span> <i class="icon-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
