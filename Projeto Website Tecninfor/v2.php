				...
				<div class="row">
					...
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<figure class="text-center">
							<img src="images/v2.jpg" alt="Free HTML5 Bootstrap" class="img-responsive">
						</figure>
					</div>
					...
					<div class="col-md-8 col-md-offset-2 animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="col-md-9 col-md-push-3">
							<h1>Computador Basic v2</h1>
							<p>Equipado com processador intel core i3-330, motherboard HM65MAL, 4Gb de ram, SSD de 120 Gb e Windows 10 Pro. Este computador é bom para quem procura um computador com um pouco mais de desempenho.</p>
				...
				<div class="row work-pagination animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="v1.php"><i class="icon-long-arrow-left"></i> <span> Artigo anterior</span></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="artigos.php"><i class="icon-th-large"></i></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="v3.php"><span>Artigo seguinte </span> <i class="icon-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
