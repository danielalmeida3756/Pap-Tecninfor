				...
				<div class="row">
					...
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<figure class="text-center">
							<img src="images/android2.jpg" alt="Erro ao carregar a imagem !" class="img-responsive">
						</figure>
					</div>
					...
					<div class="col-md-8 col-md-offset-2 animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="col-md-9 col-md-push-3">
							<h1>Android Box</h1>
							<p>Modelo CS918 Preta, equipada com processador  RK3188T, Quad Core, 2 Gb de ram, 8 Gb de Rom, Android 4.4, Wifi IEEE 802.11 b/g/n, . Interface: DC 5V, TF Card, 2x USB 2.0, SPDIF, HDMI, Ethernet Port, OTG e AV.</p>
				...
				<div class="row work-pagination animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="android1.php"><i class="icon-long-arrow-left"></i> <span> Artigo anterior</span></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
