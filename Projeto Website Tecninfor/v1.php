			...
			<div class="fh5co-narrow-content">
				<div class="row">
					...
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<figure class="text-center">
							<img src="images/v1.jpg" alt="Erro ao carregar a imagem !" class="img-responsive">
						</figure>
					</div>
					...
					<div class="col-md-8 col-md-offset-2 animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="col-md-9 col-md-push-3">
							<h1>Computador Basic V1</h1>
							<p>Equipado com processador intel core B940, motherboard HM65MAL, 4Gb de ram, SSD de 120 Gb e Windows 10 Pro. Este computador é bom para quem procura um computador a baixo preço com bom desempenho.</p>
				...
				<div class="row work-pagination animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="v2.php"><span>Artigo seguinte</span> <i class="icon-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
