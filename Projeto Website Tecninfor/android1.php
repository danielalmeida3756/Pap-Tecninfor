				...
				<div class="row">
					...
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<figure class="text-center">
							<img src="images/android1.jpg" alt="Erro ao carregar a imagem !" class="img-responsive">
						</figure>
					</div>
					...
					<div class="col-md-8 col-md-offset-2 animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="col-md-9 col-md-push-3">
							<h1>Android Box</h1>
							<p>Modelo MXQ S805 Preta, equipada com processador  Cortex A5, 1.5GHz Quad Core, GPU Mali-450, 1 Gb de ram, 8 Gb de Rom, Android 4.4, Wifi IEEE 802.11 b/g/n, Bluetooth 4.0. Interface: DC 5V, TF Card, USB 2.0, SPDIF, HDMI, OTG e AV.</p>
						...
						<div class="col-md-3 col-md-pull-9 fh5co-services">
							...
							<ul>
								...
								<li>adicionar ao</li>
								<li>seu carrinho</li>
								</p><p><a href="off.php" class="btn btn-primary btn-outline">Adicionar</a></p>
							</ul>
						</div>
				...
				<div class="row work-pagination animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="advanced.php"><i class="icon-long-arrow-left"></i> <span> Artigo anterior</span></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="artigos.php"><i class="icon-th-large"></i></a>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="android2.php"><span>Artigo seguinte </span> <i class="icon-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
