			...
			<div class="fh5co-narrow-content">
				<div class="row">
					...
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<figure class="text-center">
							<img src="images/advanced.jpg" alt="Erro ao carregar a imagem !" class="img-responsive">
						</figure>
					</div>
					...
					<div class="col-md-8 col-md-offset-2 animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="col-md-9 col-md-push-3">
							...
							<p>Equipado com processador intel core i7-2620M, motherboard HM65MAL, 8Gb de ram, SSD 120 Gb e Windows 10 Pro. Este computador é bom para quem procura um computador para jogar com uma boa taxa de fps e para trabalho com edição de videos e imagem.</p>
				...
				<div class="row work-pagination animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
							<a href="android1.php"><span>Artigo seguinte </span> <i class="icon-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
